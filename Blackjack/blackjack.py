...
def deal_card(frame):
    ...
    # add the image to a label and display
...
def score_hand(hand):
    ...
    # Only on e ace can have score of 11. Reduce to 1 if would be bust.
    score = 0
    ace = False
    for next_card in hand:
        ...
        if card_value == 1 and not ace:
            ...
            card_value = 11
        score += card_value
        # If we would go bust check for ace
        if score > 21 and ace:
            score -= 10
            ace = False
    return score
...
# Create the lists to store dealer and player hand
dealer_hand = []
player_hand = []
